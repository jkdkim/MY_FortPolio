							...
							<div class="modal-body" style="padding: 40px 50px;">
								...
								<p class="form-group">
									<select name="cate" class="form-last-name form-control">
										<option value="test1">의류</option>
										<option value="test2">여행</option>
										<option value="test3">취미</option>
										<option value="test4">자유</option>
									</select>
			...
			<div class="w3-container w3-card-2 w3-white w3-round w3-margin">
				...
				<h6 class="w3-opacity">
					<a href="/profile/${list[i].get('ID')}"> <b>${list[i].get("NAME") }</b>(${list[i].get("ID") })님
						...
						onclick="delwrite('${list[i].get('FILEUUID')}')" />
				</h6>
								...
								<div id="ment">
									...
									<div class=" list-group">
										<div class="col-sm-4 text-left">
											<div id="port2">
												<a href="javascript:showProduct()" style="color: white;"><b>상품정보가
														등록되어있습니다.</b></a>
